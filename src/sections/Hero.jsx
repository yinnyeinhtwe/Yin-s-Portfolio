      ...
      <div className="grid md:grid-cols-[2fr_1fr] gap-2 md:gap-24 items-start">
        <div className="space-y-3 mt-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="/public/YinNyeinHtwe.pdf" download className="btn-outline px-6 py-3 mt-4 rounded-full bg-black text-white transition-all duration-300 hover:scale-110 active:scale-95">Download CV</a>
          </div>
        </div>
