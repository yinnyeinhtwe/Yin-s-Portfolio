          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <div className="reveal reveal-delay-2">
              <a href="https://github.com/yinnyeinhtwe" target="_blank" rel="noreferrer"
                className="inline-flex items-center gap-2 text-sm font-bold tracking-wider uppercase border border-black rounded-full px-5 py-2.5 text-white bg-black transition-all duration-300 hover:scale-110 active:scale-95">
                GitHub
              ...
              {RENDER_LIST.map((project, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="label mb-6">{project.category}</p>
                    <h3 className="text-2xl font-bold text-black tracking-tight leading-snug mb-3">
                      {project.title}
                    </h3>
                    <p className="text-sm text-[#3D3D3D] font-normal leading-relaxed">
                      {project.description}
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex flex-wrap gap-1.5">
                      {project.tags.map((t) => (
                        <span key={t} className="chip border border-[#FFF085] rounded-full text-black font-bold bg-[#FFF085] px-3 py-1">{t}</span>
                      ))}
                    </div>
                      ...
                      <div className="flex flex-wrap gap-5 pt-1">
                        {project.links.map(({ label, href }) => (
                          <a
                            ...
                            className="inline-flex mt-2 bg-[#B8E6FE] rounded-md px-3 py-2
                            items-center gap-1 text-sm font-medium tracking-wider uppercase text-[#1A1A1A]">
                            {getLinkIcon(label)}
                            <span>{label}</span>
                          </a>
                        ))}
          ...
          <div className="reveal reveal-delay-3 flex items-center justify-between mt-6">
                ...
                return (
                  <button
                    ...
                    style={{
                      width:        active ? 20 : 8,
                      height:       8,
                      background:   active ? '#74D4FF' : '#FFF085',
                      borderRadius: 4,
                    }}
                  />
                )
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-10 h-10 border border-[#74D4FF] flex items-center justify-center
                          text-black bg-[#74D4FF] rounded-full transition-all duration-200"
              >
                <FaChevronLeft />
              </button>
              ...
              <button
                ...
                className="w-10 h-10 border border-[#FFF085] flex items-center justify-center
                          text-black font-bold bg-[#FFF085] rounded-full transition-all duration-200"
              >
                <FaChevronRight />
              </button>
            </div>
